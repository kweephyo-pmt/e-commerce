                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="grid sm:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
                                                <span className="inline-flex items-center gap-1.5">
                                                    <svg className="w-3.5 h-3.5 text-sky-400" viewBox="0 0 24 24" fill="currentColor"><path d="M11.944 0A12 12 0 0 0 0 12a12 12 0 0 0 12 12 12 12 0 0 0 12-12A12 12 0 0 0 12 0a12 12 0 0 0-.056 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 0 1 .171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.48.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
                                                    Telegram URL
                                                </span>
                                            </label>
                                            <input
                                                ...
                                                onChange={e => setFooterForm(prev => ({ ...prev, telegram: e.target.value }))}
                                                placeholder="https://t.me/yourchannel"
                                                className="w-full bg-gray-800 border-2 border-sky-500/30 corner-clip-sm text-white px-4 py-3 focus:outline-none focus:border-sky-400 transition-all font-bold text-sm"
                                                style={{ fontFamily: 'Rajdhani, sans-serif' }}
                                            />
                                        </div>
                                        {/* TikTok */}
                                        <div>
                                            <label className="block text-xs font-black text-gray-400 uppercase tracking-widest mb-2" style={{ fontFamily: 'Rajdhani, sans-serif' }}>
                                                <span className="inline-flex items-center gap-1.5">
                                                    <svg className="w-3.5 h-3.5 text-pink-500" viewBox="0 0 16 16" fill="currentColor"><path d="M9 0h1.98c.144.715.54 1.617 1.235 2.512C12.895 3.389 13.797 4 15 4v2c-1.753 0-3.07-.814-4-1.829V11a5 5 0 1 1-5-5v2a3 3 0 1 0 3 3z"/></svg>
                                                    TikTok URL
                                                </span>
                                            </label>
                                            <input
                                                ...
                                                onChange={e => setFooterForm(prev => ({ ...prev, tiktok: e.target.value }))}
                                                placeholder="https://tiktok.com/@youraccount"
                                                className="w-full bg-gray-800 border-2 border-pink-500/30 corner-clip-sm text-white px-4 py-3 focus:outline-none focus:border-pink-500 transition-all font-bold text-sm"
                                                style={{ fontFamily: 'Rajdhani, sans-serif' }}
                                            />
                                        </div>
                                    </div>
