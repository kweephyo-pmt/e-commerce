                                    ...
                                    <div className="grid sm:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            ...
                                            <input
                                                ...
                                                onChange={e => setFooterForm(prev => ({ ...prev, discord: e.target.value }))}
                                                placeholder="https://discord.gg/yourinvite"
                                                className="w-full bg-gray-800 border-2 border-indigo-500/30 corner-clip-sm text-white px-4 py-3 focus:outline-none focus:border-indigo-400 transition-all font-bold text-sm"
                                                style={{ fontFamily: 'Rajdhani, sans-serif' }}
                                            />
                                        </div>
                                    </div>
